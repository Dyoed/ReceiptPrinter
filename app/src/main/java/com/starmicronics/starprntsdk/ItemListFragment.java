...
//        webView.loadUrl("https://drive.google.com/open?id=19KRCh2ko9_i-jBRgmSdUsvIF1E4TCu5c");
    ...
    protected void addSwitchMenu(String title, boolean isChecked, int backGroundColor, String tag, CompoundButton.OnCheckedChangeListener listener) {
        List<TextInfo>   textList   = new ArrayList<>();
        ...
        adapter.add(new ItemList(R.layout.list_allreceipts_print_setting_row, textList, switchList, backGroundColor, true));
    }
}
