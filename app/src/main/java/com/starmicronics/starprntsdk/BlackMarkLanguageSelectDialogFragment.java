...
public class BlackMarkLanguageSelectDialogFragment extends CommonAlertDialogFragment {

    private Callback mCallbackTarget;

    public static BlackMarkLanguageSelectDialogFragment newInstance(String tag) {
        BlackMarkLanguageSelectDialogFragment dialogFragment = new BlackMarkLanguageSelectDialogFragment();
