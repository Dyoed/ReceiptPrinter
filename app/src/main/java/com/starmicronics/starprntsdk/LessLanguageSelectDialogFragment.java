...
public class LessLanguageSelectDialogFragment extends CommonAlertDialogFragment {

    private Callback mCallbackTarget;

    public static LessLanguageSelectDialogFragment newInstance(String tag) {
        LessLanguageSelectDialogFragment dialogFragment = new LessLanguageSelectDialogFragment();
