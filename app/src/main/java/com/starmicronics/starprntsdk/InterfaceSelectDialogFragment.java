...
public class InterfaceSelectDialogFragment extends CommonAlertDialogFragment {
    ...
    private DialogInterface.OnClickListener mOnInterfaceClickListener = new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            switch (which) {
                case 0:
                    selectedInterfaceArray = new String[] {PrinterSetting.IF_TYPE_ETHERNET};
                    break;
                case 1:
                    selectedInterfaceArray = new String[] {PrinterSetting.IF_TYPE_BLUETOOTH};
                    break;
                case 2:
                    selectedInterfaceArray = new String[] {PrinterSetting.IF_TYPE_USB};
                    break;
                case 3:
                default:
                    selectedInterfaceArray = new String[] {PrinterSetting.IF_TYPE_ETHERNET, PrinterSetting.IF_TYPE_BLUETOOTH, PrinterSetting.IF_TYPE_USB};
                    break;
                case 4:
                    selectedInterfaceArray = new String[] {PrinterSetting.IF_TYPE_MANUAL};
                    break;
            }
