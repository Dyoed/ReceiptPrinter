...
public final class DeviceStatusFragment extends ItemListFragment implements CommonAlertDialogFragment.Callback {
    ...
    private void createStatusItems(StarPrinterStatus status) {
        ...
        if (status.receiptPaperEmpty) {
            ...
            addItem("Paper", "Near Empty", Color.YELLOW);
        }
        else {
        ...
        if (setting.getCashDrawerOpenActiveHigh()) {
            addItem("Cash Drawer",
    ...
    private void retrieveStatus() {
        ...
        Communication.retrieveStatus(DeviceStatusFragment.class, setting.getPortName(), setting.getPortSettings(), 10000, getActivity(), mStatusCallback);
    }
    ...
    private void getFirmwareInformation() {
        ...
        Communication.getFirmwareInformation(DeviceStatusFragment.class, setting.getPortName(), setting.getPortSettings(), 10000, getActivity(), mFirmwareInformationCallback);
    }
