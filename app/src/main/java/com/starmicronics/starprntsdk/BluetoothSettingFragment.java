...
public class BluetoothSettingFragment extends Fragment implements CommonAlertDialogFragment.Callback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mApplyButton = (Button) rootView.findViewById(R.id.bluetoothSettingApplyButton);

        mDeviceNameEditText = (EditText) rootView.findViewById(R.id.bluetoothSettingDeviceNameEditText);
        ...
        miOSPortNameEditText = (EditText) rootView.findViewById(R.id.bluetoothSettingiOSPortNameEditText);
        ...
        mAutoConnectSwitch = (Switch) rootView.findViewById(R.id.bluetoothSettingAutoConnectSwitch);
        ...
        mSecurityValueTextView = (TextView) rootView.findViewById(R.id.bluetoothSettingSecurityValueTextView);
        ...
        mChangePinCodeSwitch = (Switch) rootView.findViewById(R.id.bluetoothSettingChangePinCodeSwitch);
        ...
        mNewPinCodeEditText = (EditText) rootView.findViewById(R.id.bluetoothSettingNewPinCodeEditText);
        ...
        mGrayOutView = (Button) rootView.findViewById(R.id.grayoutView);
    ...
    private class FirmwareVersionCheckTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            Communication.getFirmwareInformation(BluetoothSettingFragment.class, setting.getPortName(), setting.getPortSettings(), 10000, getActivity(), mCallback);
